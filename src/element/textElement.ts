...
const DEFAULT_LINE_HEIGHT = {
  // ~1.25 is the average for Qingmei in WebKit and Blink.
  // Gecko (FF) uses ~1.28.
  [FONT_FAMILY.Qingmei]: 1.25 as ExcalidrawTextElement["lineHeight"],
  // ~1.15 is the average for Qingmei in WebKit and Blink.
  // Gecko if all over the place.
  [FONT_FAMILY.Helvetica]: 1.15 as ExcalidrawTextElement["lineHeight"],
  // ~1.2 is the average for Qingmei in WebKit and Blink, and kinda Gecko too
